...
export const STAGE_TRANSITION_LABELS = [
  ...
  { from: 'accepted_campaign', to: 'assigned_to_campaign', label: 'Accepted Campaign → Assigned to Campaign' },
  { from: 'assigned_to_campaign', to: 'products_chosen', label: 'Assigned to Campaign → Products Chosen' },
